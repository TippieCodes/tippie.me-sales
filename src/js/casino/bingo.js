...
function linePatternLoop(){
    if ($("#pattern").val() === "line") {
        ...
        loop++;
        setTimeout(function(){linePatternLoop()},1000)
    }
}
...
function saveWinCondition() {
    ...
    setTimeout(function(){$("#win-condition-result").text("")},5000)
}
...
function copyBook(){
    ...
    if (new_card == undefined) {
        ...
        setTimeout(function(){$("#manage-card-result").text("")},10000)
        return;
    }
...
function checkWinCondition(card){
    ...
    if (winCondition === "line") {
        ...
        if (r === true) {rolled.pop(); return true;}
        r = true
        ...
        if (r === true) {rolled.pop(); return true;}
        r = false;
        if (rolled.includes(card.B[0]) && rolled.includes(card.I[0]) && rolled.includes(card.N[0]) && rolled.includes(card.G[0]) && rolled.includes(card.O[0])) {rolled.pop(); return true;}
        if (rolled.includes(card.B[1]) && rolled.includes(card.I[1]) && rolled.includes(card.N[1]) && rolled.includes(card.G[1]) && rolled.includes(card.O[1])) {rolled.pop(); return true;}
        if (rolled.includes(card.B[2]) && rolled.includes(card.I[2]) && rolled.includes(card.N[2]) && rolled.includes(card.G[2]) && rolled.includes(card.O[2])) {rolled.pop(); return true;}
        if (rolled.includes(card.B[3]) && rolled.includes(card.I[3]) && rolled.includes(card.N[3]) && rolled.includes(card.G[3]) && rolled.includes(card.O[3])) {rolled.pop(); return true;}
        if (rolled.includes(card.B[4]) && rolled.includes(card.I[4]) && rolled.includes(card.N[4]) && rolled.includes(card.G[4]) && rolled.includes(card.O[4])) {rolled.pop(); return true;}
        if (rolled.includes(card.B[0]) && rolled.includes(card.I[1]) && rolled.includes(card.N[2]) && rolled.includes(card.G[3]) && rolled.includes(card.O[4])) {rolled.pop(); return true;}
        if (rolled.includes(card.B[4]) && rolled.includes(card.I[3]) && rolled.includes(card.N[2]) && rolled.includes(card.G[1]) && rolled.includes(card.O[0])) {rolled.pop(); return true;}
        ...
        if (rolled.includes(card.B[0]) && rolled.includes(card.I[0]) && rolled.includes(card.N[0]) && rolled.includes(card.G[0]) && rolled.includes(card.O[0]) &&
            ...
            rolled.includes(card.O[1]) && rolled.includes(card.O[2]) && rolled.includes(card.O[3])) {rolled.pop(); return true;}
        ...
        if (rolled.includes(card.B[0]) && rolled.includes(card.I[1]) && rolled.includes(card.N[2]) && rolled.includes(card.G[3]) && rolled.includes(card.O[4]) &&
            rolled.includes(card.B[4]) && rolled.includes(card.I[3]) && rolled.includes(card.N[2]) && rolled.includes(card.G[1]) && rolled.includes(card.O[0])) {rolled.pop(); return true;}
        ...
        if (rolled.includes(card.B[3]) && rolled.includes(card.I[3]) && rolled.includes(card.N[3]) && rolled.includes(card.G[3]) && rolled.includes(card.O[3]) &&
            rolled.includes(card.N[1]) && rolled.includes(card.N[2]) && rolled.includes(card.N[4]) && rolled.includes(card.N[0])) {rolled.pop(); return true;}
    } else if (winCondition === "custom"){
        if (customWinGrid[0][0]) {
            if (!rolled.includes(card.B[0])) {rolled.pop(); return false;}
        }
        if (customWinGrid[1][0]) {
            if (!rolled.includes(card.B[1])) {rolled.pop(); return false;}
        }
        if (customWinGrid[2][0]) {
            if (!rolled.includes(card.B[2])) {rolled.pop(); return false;}
        }
        if (customWinGrid[3][0]) {
            if (!rolled.includes(card.B[3])) {rolled.pop(); return false;}
        }
        if (customWinGrid[4][0]) {
            if (!rolled.includes(card.B[4])) {rolled.pop(); return false;}
        }

        if (customWinGrid[0][1]) {
            if (!rolled.includes(card.I[0])) {rolled.pop(); return false;}
        }
        if (customWinGrid[1][1]) {
            if (!rolled.includes(card.I[1])) {rolled.pop(); return false;}
        }
        if (customWinGrid[2][1]) {
            if (!rolled.includes(card.I[2])) {rolled.pop(); return false;}
        }
        if (customWinGrid[3][1]) {
            if (!rolled.includes(card.I[3])) {rolled.pop(); return false;}
        }
        if (customWinGrid[4][1]) {
            if (!rolled.includes(card.I[4])) {rolled.pop(); return false;}
        }

        if (customWinGrid[0][2]) {
            if (!rolled.includes(card.N[0])) {rolled.pop(); return false;}
        }
        if (customWinGrid[1][2]) {
            if (!rolled.includes(card.N[1])) {rolled.pop(); return false;}
        }
        if (customWinGrid[2][2]) {
            if (!rolled.includes(card.N[2])) {rolled.pop(); return false;}
        }
        if (customWinGrid[3][2]) {
            if (!rolled.includes(card.N[3])) {rolled.pop(); return false;}
        }
        if (customWinGrid[4][2]) {
            if (!rolled.includes(card.N[4])) {rolled.pop(); return false;}
        }

        if (customWinGrid[0][3]) {
            if (!rolled.includes(card.G[0])) {rolled.pop(); return false;}
        }
        if (customWinGrid[1][3]) {
            if (!rolled.includes(card.G[1])) {rolled.pop(); return false;}
        }
        if (customWinGrid[2][3]) {
            if (!rolled.includes(card.G[2])) {rolled.pop(); return false;}
        }
        if (customWinGrid[3][3]) {
            if (!rolled.includes(card.G[3])) {rolled.pop(); return false;}
        }
        if (customWinGrid[4][3]) {
            if (!rolled.includes(card.G[4])) {rolled.pop(); return false;}
        }

        if (customWinGrid[0][4]) {
            if (!rolled.includes(card.O[0])) {rolled.pop(); return false;}
        }
        if (customWinGrid[1][4]) {
            if (!rolled.includes(card.O[1])) {rolled.pop(); return false;}
        }
        if (customWinGrid[2][4]) {
            if (!rolled.includes(card.O[2])) {rolled.pop(); return false;}
        }
        if (customWinGrid[3][4]) {
            if (!rolled.includes(card.O[3])) {rolled.pop(); return false;}
        }
        if (customWinGrid[4][4]) {
            if (!rolled.includes(card.O[4])) {rolled.pop(); return false;}
        }
        rolled.pop();
        return true;
    }
